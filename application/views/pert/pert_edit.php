                                            ...
                                            <form action="<?php echo base_url('pert/calculate') ?>" method="post">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><input class="form-control text-center p-1" style="font-size: 13px; width: 100px;" type="number" name="task_opt_<?php echo $i; ?>" id="task_opt_<?php echo $i; ?>" value="<?php echo $task['opt']; ?>" step="any" min="1" max="100" placeholder="Max. 100" onchange="check_opt(this)" required></td>
                                                        <td><input class="form-control text-center p-1" style="font-size: 13px; width: 100px;" type="number" name="task_ml_<?php echo $i; ?>" id="task_ml_<?php echo $i; ?>" value="<?php echo $task['ml']; ?>" step="any" min="1" max="100" placeholder="Max. 100" onchange="check_ml(this)" required></td>
                                                        <td><input class="form-control text-center p-1" style="font-size: 13px; width: 100px;" type="number" name="task_pes_<?php echo $i; ?>" id="task_pes_<?php echo $i; ?>" value="<?php echo $task['pes']; ?>" step="any" min="1" max="100" placeholder="Max. 100" onchange="check_pes(this)" required></td>
                                                        <td><?php
                                                            if ($i == 1) {
                                                            ?>
