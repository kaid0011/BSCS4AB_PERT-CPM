<div class="mainpg">
    <div class="body-container">
                ...
                <div class="form">
                    <form action="<?= base_url('normal/proj_details') ?>" method="post">
                        <div class="form-group">
                            ...
                            <input type="number" name="proj_len" class="form-control" id="InputTask" min="2" max="20" oninput="validity.valid||(value='');" aria-describedby="input" placeholder="Max. 20." required>
                        </div>
                        <div class="form-group">
        ...
        <center>
            <div class="sample">
            <a class="btn" href="<?= base_url('normal/demo/demo1') ?>">Demo 1</a>
            <a class="btn" href="<?= base_url('normal/demo/demo2') ?>">Demo 2</a>
            <a class="btn" href="<?= base_url('normal/demo/demo3') ?>">Demo 3</a>
            </div>
        </center>
        </form>
    </div>
