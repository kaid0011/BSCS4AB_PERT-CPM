    ...
    <section class="collapsible">
        ...
        <div class="content">
            <p>
                ...
                <strong>Step 3:</strong> Calculates the duration (T) by getting the mean of the 3 durations.<br>
                <img style="height: 2.5em; width: auto;" src="<?=base_url('assets/images/pert_mean.png')?>"></img><br><br>
