<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>How Normal Distribution Works</h1>
        <nav>
            <ol class="breadcrumb">
    ...
    <section class="section">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">How does WAPS with Simulation's Normal Distribution calculation works?</h5>
                        <div class="summary">
                            ...
                            <p class="text-muted small ps-3"><strong>Step 3: </strong> Calculates the mean (𝜇) of the 3 durations for each activity.</p>
                            <center><img class="mt-1 mb-1" style="height: 50px;" src="<?= base_url('assets/images/howitworks/normal_mean.png') ?>">
                            </center>
                            <p class="text-muted small ps-3"><strong>Step 4: </strong> Calculates the variance (𝜎<sup>2</sup>) of the 3 durations for each activity.</p>
                            <center><img class="mt-1 mb-1" style="height: 50px;" src="<?= base_url('assets/images/howitworks/normal_variance.png') ?>">
                            </center>
                            <p class="text-muted small ps-3"><strong>Step 5: </strong> Calculates the standard deviation (𝜎) using the variance for each activity.</p>
                            <center><img class="mt-1 mb-1" style="height: 50px;" src="<?= base_url('assets/images/howitworks/normal_sd.png') ?>">
                            </center>
                            <p class="text-muted small ps-3"><strong>Step 6: </strong> Computes the duration (T) by using the norm.ppf function from scipy.stats to get the normal distribution value
                                (or the inverse of the cumulative distribution function) for which a given probability is the required value.</p>
                            <div class="func ps-4">
                                <div class="title">
                                    <p class="text-muted small ps-3"><i>norm.ppf(q, loc=0, scale=1)</i></p>
                                </div>
                            ...
                            <p class="text-muted small ps-3"><strong>Step 7: </strong> Identifies the pre-requisites of each activity, which must be completed before another activity starts.</p>
                            <p class="text-muted small ps-3"><strong>Step 8: </strong> Performs a Forward Pass.</p>

                            <ol type="a">
                                <li>
                                    <p class="text-muted small ps-3">Forward Pass starts with the first activity, to determine the Early Start Time (ES) and Early Finish Time (EF) for each activity.
                                    </p>
                                </li>
                                <li>
