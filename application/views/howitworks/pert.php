    ...
    <section class="section">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">How does WAPS with Simulation's PERT calculation works?</h5>
                        <div class="summary">
                            ...
                            <p class="text-muted small ps-3 mb-0"><strong>Step 3: </strong> Calculates the duration (T) by getting the mean of the 3 durations.</p>
                            <center><img class="mt-1 mb-1" style="height: 50px;" src="<?= base_url('assets/images/howitworks/pert_mean.png') ?>"></img></center>
                            <p class="text-muted small ps-3"><strong>Step 4: </strong> Identifies the pre-requisites of each activity, which must be completed before another activity starts.</p>
                            <p class="text-muted small ps-3"><strong>Step 5: </strong> Performs a Forward Pass.</p>
                            <ol type="a">
                                <li>
                            ...
                            <p class="text-muted small ps-3"><strong>Step 6: </strong> Performs a Backward Pass.</p>
                            <ol type="a">
                                <li>
                            ...
                            <p class="text-muted small ps-3"><strong>Step 7: </strong> Uses the Earliest Start Time (ES) and Latest Finish Time (LF) of each activity to create a Gantt Chart. The darker colored bars represent the critical values which complete the Critical Path.</p>
