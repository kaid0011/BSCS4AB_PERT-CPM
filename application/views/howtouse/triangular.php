<div class="howtouse">
    <div class="body-container">
        <div class="summary">
            <h1>How to use WAPS with Simulation's Triangular Distribution?</h1>
            <h3>To use WAPS with Simulation's Triangular Distribution?, you must follow these steps:</h3>
            <ol type="1">
                <li>
        ...
        <div class="explained">
            ...
            <center><img class="how1" alt="" src="<?= base_url() ?>/assets/images/howtouse/triangular/tria1.png"></center>
            <ul>
                <li>
                    <p>Click 'Generate Table' to generate a table to input your project details.</p>
                </li>
            </ul>
            <center><img class="how5" alt="" src="<?= base_url() ?>/assets/images/howtouse/triangular/tria2.png"></center>
            <ul>
                <li>
            ...
            <center><img class="how5" alt="" src="<?= base_url() ?>/assets/images/howtouse/triangular/tria3.png"></center>
            <ul>
                <li>
            ...
            <center><img class="how3" alt="" src="<?= base_url() ?>/assets/images/howtouse/triangular/tria4.png"></center>
            <center><img class="how3" alt="" src="<?= base_url() ?>/assets/images/howtouse/triangular/tria5.png"></center>
            <center><img class="how4" alt="" src="<?= base_url() ?>/assets/images/howtouse/triangular/tria6.png"></center>
            <ul>
                <li>
                    <p>Additionally, a gantt chart is provided for better visualization of the scheduled project activities.</p>
                </li>
            </ul>
            <center><img class="how5" alt="" src="<?= base_url() ?>/assets/images/howtouse/triangular/tria7.png"></center>
        </div>
    </div>
</div>