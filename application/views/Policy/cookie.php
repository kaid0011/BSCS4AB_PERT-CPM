<html lang="en"><head>
    <title>Cookies Policy for WAPS with Simulation</title>
    <meta charset="utf-8">
    ...
    <div class="header">
    <div class="container">
    <p class="title" font-size="24px" line-height="36px" font-weight="700" margin="0">Cookies Policy for WAPS with Simulation</p>
    </div>
    </div>
    ...
    <p>This Cookies Policy explains what Cookies are and how We use them. You should read this policy so You can understand what type of cookies We use, or the information We collect using Cookies and how that information is used. This Cookies Policy has been created with the help of theCookies Policy Generator.</p>
    ...
    <ul>
    <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to WAPS with Simulation.</li>
    <li><strong>Cookies</strong> means small files that are placed on Your computer, mobile device or any other device by a website, containing details of your browsing history on that website among its many uses.</li>
    <li><strong>Website</strong> refers to WAPS with Simulation, accessible from <a href="http://localhost/BSCS4AB_PERT-CPM" rel="external nofollow noopener" target="_blank">http://localhost/BSCS4AB_PERT-CPM</a></li>
    ...
    <ul>
    <li>
    <p>By email: waps_simulation@gmail.com</p>
    </li>
    <li>
    <p>By visiting this page on our website: <a href="http://localhost/BSCS4AB_PERT-CPM" rel="external nofollow noopener" target="_blank">http://localhost/BSCS4AB_PERT-CPM</a></p>
    </li>
    </ul>
    </div>
    </div>
