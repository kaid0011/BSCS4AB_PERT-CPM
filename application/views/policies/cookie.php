<div class="policypg">
    <div class="body-container">
        <h1>Cookies Policy for WAPS with Simulation</h1>
        ...
        <ul>
            <li>
                <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Cookies Policy) refers to WAPS with Simulation.</p>
            </li>
            <li>
        ...
        <ul>
            <li>
                <p>By email: pertcpmsimulations@kaid.tech</p>
            </li>
            <li>
                <p>By visiting this page on our website: <a href="https://pertcpmsimulations.online" rel="external nofollow noopener" target="_blank">https://pertcpmsimulations.online</a></p>
            </li>
        </ul>
    </div>
</div>