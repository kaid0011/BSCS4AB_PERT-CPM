                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="text-muted small mb-4">Enter the details of your project's tasks for the calculator to compute.</p>
                                            ...
                                            <form action="<?php echo base_url('cpm/calculate') ?>" method="post">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><input class="form-control text-center p-1" style="width: 150px; font-size: 13px;" type="text" name="task_name_<?php echo $i; ?>" id="task_name_<?php echo $i; ?>"></td>
                                                        <td><input class="form-control text-center p-1" style="width: 150px; font-size: 13px;" type="text" name="task_desc_<?php echo $i; ?>" id="task_desc_<?php echo $i; ?>"></td>
                                                        <td><input class="form-control text-center p-1" style="width: 100px; font-size: 13px;" type="number" name="task_time_<?php echo $i; ?>" id="task_time_<?php echo $i; ?>" min="1" max="100" placeholder="Max. 100" step="any" oninput="validity.valid||(value='');" required><span style="font-size: 11px;"><?php echo $_SESSION['unit'] ?></span></td>
                                                        <td><?php
                                                                                        if ($i == 1) {
                                                                                        ?>
                                                                ...
                                                                <?php
                                                                                            ...
                                                                                            if ($i <= 10) {
                                                                ?>
                                                                    <input class="form-control text-center p-1" style="width: 150px; font-size: 13px;" type="text" name="task_prereq_<?php echo $i; ?>" id="task_prereq_<?php echo $i; ?>" pattern="[1-<?php echo $x; ?>](;[1-<?php echo $x; ?>])*|^[\-]" oninvalid="this.setCustomValidity('Enter Valid Activity ID')" onchange="this.setCustomValidity('')" required>
                                                                <?php
                                                                                            } else if ($i > 10) {
                                                                                                $y = $i - 11;
                                                                ?>
                                                                    <input class="form-control text-center p-1" style="width: 150px; font-size: 13px;" type="text" name="task_prereq_<?php echo $i; ?>" id="task_prereq_<?php echo $i; ?>" pattern="([1-9]|1[0-<?php echo $y; ?>])(;([1-9]|1[0-<?php echo $y; ?>]))*|^[\-]" oninvalid="this.setCustomValidity('Enter Valid Activity ID')" onchange="this.setCustomValidity('')" required>
                                                            <?php }
                                                                                        } ?>
                                                        </td>
                                                    </tr>
