                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input class="form-control numoftrials" style="font-size: 13px;" type="numbers" name="N" min="1" max="1000" oninput="validity.valid||(value='');" placeholder="Max. 1000" required>
                                    </div>
