                                            ...
                                            <form action="<?php echo base_url('betapert/calculate') ?>" method="post">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><input class="form-control text-center p-1" style="font-size: 13px; width: 100px;" type="number" name="task_pes_<?php echo $i; ?>" id="task_pes_<?php echo $i; ?>" step="any" min="1" max="100" placeholder="Max. 100" onchange="check_pes(this)" required style="margin-right: 2px;"><span style="font-size: 11px;"><?php echo $_SESSION['unit'] ?></span></td>
                                                        <td><?php
                                                            if ($i == 1) {
                                                            ?>
