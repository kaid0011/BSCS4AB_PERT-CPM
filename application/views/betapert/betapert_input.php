        ...
        <div class="grid-container">
            <div class="tablecontainer" style="overflow-x:auto">
                <table class="results">
                    ...
                    <tbody>
                        <form action="<?php echo base_url('betapert/calculate') ?>" method="post"> <?php
                                    ...
                                    <td><?php
                                                                                                        if ($i == 1) {
                                        ?> <input type="text" name="task_prereq_<?php echo $i; ?>" value="-" readonly="readonly"> <?php
                                                                                                                                } else { ?> <input type="text" name="task_prereq_<?php echo $i; ?>" pattern="[1-<?php echo $i - 1; ?>](,[1-<?php echo $i - 1; ?>])*|^[\-]" oninvalid='this.setCustomValidity("Enter Valid Activity ID")' onchange='this.setCustomValidity("")' required> <?php } ?> </td>
                                </tr> <?php }
                                        ?>
                    </tbody>
                </table>
